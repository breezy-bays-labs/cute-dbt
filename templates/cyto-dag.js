...
(function () {
  ...
  function computeDepths(nodes, edges) {
    ...
    edges.forEach(function (e) {
      if (adj[e.from] && Object.prototype.hasOwnProperty.call(indeg, e.to)) {
  ...
  function render(m, selectedNodeId) {
    ...
    // when the engine flip unhid it this same frame.
    window.requestAnimationFrame(function () { if (cy) cy.fit(undefined, 28); });
  }
