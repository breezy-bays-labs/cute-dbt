...
use crate::domain::{
    ...
    DepDate, EnabledExperiments, EnvelopeScope, Experiment, FixtureTableDiff, GovernanceFacts,
    HeuristicId, InScopeSet, Manifest, ModelInScopeSet, ModelYamlOutcome, NamedTableDiff,
    NormalizedDiffIndex, PrConfig, PrRef, PreflightError, ProjectChangePanel, ProjectFacts,
    ProjectFallbackReason, ScopeInput, ScopeSelection, SeedCard, SeedInScopeSet, SuppressRule,
